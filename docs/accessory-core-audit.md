...
| Unified equipped query API | Queries scattered via `EquipmentUtil` and raw container access | Add unified bridge/query API over accessory core snapshots | DONE |
