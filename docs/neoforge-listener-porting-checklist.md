...
This checklist maps legacy NeoForge listener points from `The-Aether` 1.21.1 to the current Fabric-side implementation in `The-Aether-fabric` 1.21.11.
...
| `onLoadPlayerFile` (legacy Curios migration) | `ServerPlayerEvents.JOIN` calling `loadLegacyCuriosData` | Done |
