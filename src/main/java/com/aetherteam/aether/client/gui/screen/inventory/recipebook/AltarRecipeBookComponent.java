...
public class AltarRecipeBookComponent extends RecipeBookComponent<AbstractAetherFurnaceMenu> {
    private static final WidgetSprites FILTER_SPRITES = new WidgetSprites(
        Identifier.fromNamespaceAndPath(Aether.MODID, "recipe_book/altar_filter_enabled"),
        Identifier.fromNamespaceAndPath(Aether.MODID, "recipe_book/altar_filter_disabled"),
        Identifier.fromNamespaceAndPath(Aether.MODID, "recipe_book/altar_filter_enabled_highlighted"),
        Identifier.fromNamespaceAndPath(Aether.MODID, "recipe_book/altar_filter_disabled_highlighted")
    );
