...
public class AetherRenderers {
    ...
    public static void registerLayerDefinitions() {
        ...
        EntityModelLayerRegistry.registerModelLayer(AetherModelLayers.PHYG_BABY, () -> PigModel.createBodyLayer(CubeDeformation.NONE));
        ...
        EntityModelLayerRegistry.registerModelLayer(AetherModelLayers.FLYING_COW_BABY, CowModel::createBodyLayer);
