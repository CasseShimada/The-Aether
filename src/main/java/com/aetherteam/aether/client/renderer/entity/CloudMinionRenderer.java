...
public class CloudMinionRenderer extends MobRenderer<CloudMinion, LivingEntityRenderState, CloudMinionModel> {
    private static final Identifier CLOUD_MINION_TEXTURE = Identifier.fromNamespaceAndPath(Aether.MODID, "textures/entity/miscellaneous/cloud_minion/cloud_minion.png");
