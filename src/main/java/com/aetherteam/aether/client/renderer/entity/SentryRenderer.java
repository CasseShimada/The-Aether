...
public class SentryRenderer extends MobRenderer<Sentry, SentryRenderState, SlimeModel> {
    private static final Identifier SENTRY_TEXTURE = Identifier.fromNamespaceAndPath(Aether.MODID, "textures/entity/mobs/sentry/sentry.png");
    private static final Identifier SENTRY_LIT_TEXTURE = Identifier.fromNamespaceAndPath(Aether.MODID, "textures/entity/mobs/sentry/sentry_lit.png");
    ...
    @Override
    public Identifier getTextureLocation(SentryRenderState renderState) {
