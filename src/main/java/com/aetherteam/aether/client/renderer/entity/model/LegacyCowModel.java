    ...
    public static LayerDefinition createBodyLayer(CubeDeformation deformation) {
        ...
        root.addOrReplaceChild("head",
                CubeListBuilder.create()
                        .texOffs(0, 0)
                        .addBox(-4.0F, -4.0F, -6.0F, 8.0F, 8.0F, 6.0F, deformation)
                        .texOffs(22, 0)
                        .addBox("right_horn", -5.0F, -5.0F, -4.0F, 1.0F, 3.0F, 1.0F, deformation)
                        .texOffs(22, 0)
                        .addBox("left_horn", 4.0F, -5.0F, -4.0F, 1.0F, 3.0F, 1.0F, deformation),
                PartPose.offset(0.0F, 4.0F, -8.0F));

        root.addOrReplaceChild("body",
                CubeListBuilder.create()
                        .texOffs(18, 4)
                        .addBox(-6.0F, -10.0F, -7.0F, 12.0F, 18.0F, 10.0F, deformation)
                        .texOffs(52, 0)
                        .addBox(-2.0F, 2.0F, -8.0F, 4.0F, 6.0F, 1.0F, deformation),
