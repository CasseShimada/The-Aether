...
public class QuadrupedWingsModel<T extends WingEntityRenderState> extends EntityModel<T> {
    ...
    public static LayerDefinition createMainLayer(float offset) {
        ...
        leftWingInnerDef.addOrReplaceChild("left_wing_outer", CubeListBuilder.create().texOffs(20, 0).mirror().addBox(-1.0F, -16.0F, 0.01F, 2.0F, 16.0F, 7.98F), PartPose.offset(0.0F, -16.0F, 0.0F));
        ...
        rightWingInnerDef.addOrReplaceChild("right_wing_outer", CubeListBuilder.create().texOffs(20, 0).addBox(-1.0F, -16.0F, 0.01F, 2.0F, 16.0F, 7.98F), PartPose.offset(0.0F, -16.0F, 0.0F));
