...
public class Phyg extends WingedAnimal {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(4, new TemptGoal(this, 1.2, Ingredient.of(this.registryAccess().lookupOrThrow(Registries.ITEM).getOrThrow(AetherTags.Items.PHYG_TEMPTATION_ITEMS)), false));
