...
public class AltarMenu extends AbstractAetherFurnaceMenu {
    public AltarMenu(int containerId, Inventory playerInventory) {
        super(AetherMenuTypes.ALTAR, AetherRecipeTypes.ENCHANTING, AetherRecipePropertySets.ALTAR_INPUT, AetherRecipeBookTypes.ALTAR, containerId, playerInventory);
    }

    public AltarMenu(int containerId, Inventory playerInventory, Container altarContainer, ContainerData data) {
        super(AetherMenuTypes.ALTAR, AetherRecipeTypes.ENCHANTING, AetherRecipePropertySets.ALTAR_INPUT, AetherRecipeBookTypes.ALTAR, containerId, playerInventory, altarContainer, data);
    }

    @Override
    public boolean isFuel(ItemStack stack) {
        return AetherDataMaps.isAltarFuel(stack);
    }
}
