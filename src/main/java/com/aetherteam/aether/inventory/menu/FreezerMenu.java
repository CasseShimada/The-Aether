...
public class FreezerMenu extends AbstractAetherFurnaceMenu {
    public FreezerMenu(int containerId, Inventory playerInventory) {
        super(AetherMenuTypes.FREEZER, AetherRecipeTypes.FREEZING, AetherRecipePropertySets.FREEZER_INPUT, AetherRecipeBookTypes.FREEZER, containerId, playerInventory);
    }

    public FreezerMenu(int containerId, Inventory playerInventory, Container freezerContainer, ContainerData data) {
        super(AetherMenuTypes.FREEZER, AetherRecipeTypes.FREEZING, AetherRecipePropertySets.FREEZER_INPUT, AetherRecipeBookTypes.FREEZER, containerId, playerInventory, freezerContainer, data);
    }
